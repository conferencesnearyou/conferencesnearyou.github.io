(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		if (document.getElementById('calcular')) {
			...
			function validarNombre() {
				if (this.value.indexOf('a') > -1) {
					...
					errorDiv.style.display = 'block';
					errorDiv.innerHTML = 'debe tener al menos una letra';
					this.style.border = '1px solid red';
					errorDiv.style.border = '1px solid red';
				}
			}
		...
		if (document.getElementById('mapa')) {
			var map = L.map('mapa').setView([ 18.13760407301071, -94.52315000467622 ], 30);

			L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);

			L.marker([ 18.13760407301071, -94.52315000467622 ]).addTo(map).bindPopup('Conferences Near you 2022').openPopup();
			// .bindTooltip('Conferences Near you 2022, Boletos ya disponibles')
			// .openTooltip();
		}
